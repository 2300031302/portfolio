...
const Projects = () => {
  const projects = [
    {
      title: "File Share - online file sharing platform",
      description: "A comprehensive sharing platform where users can upload and share files, including images. Features include user authentication, file sharing, easy download links, and a responsive dashboard.",
      image:  "ofs.png",
      technologies: ["React.ts", "Spring Boot", "SQL", "Tailwind CSS"],
      github: "https://github.com/2300031302/ofsfe",
      demo:  "https://cidd-fs.vercel.app/home"
    },
    {
